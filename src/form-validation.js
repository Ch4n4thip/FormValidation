  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit(onSubmitForm)}>
        ...
        />
        {errors.price && (
          <div style={err}>กําหนดราคาสินค้าเป็นตัวเลขที่มากกว่า 0</div>
        )}
        <div className="form-group mb-3">
          ...
          ></textarea>
          {errors.detail && <div style={err}>ต้องกําหนดรายละเอียดสินค้า</div>}
        </div>
        <div className="form-group mb-3">
        ...
        <div className="form-group mb-3">
          <label htmlFor="file" className="form-label">
            ภาพสินค้า * (ไม่เกิน 3ไฟล์ ขนาดสูงสุด 300 KB/ไฟล์)
          </label>
          <input
            type="file"
            id="file"
